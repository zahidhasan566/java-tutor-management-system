...
public class Show_Student extends JFrame implements ActionListener
{
	...
	public Show_Student()
	{
		...
		//String [][]row;
		String []col ={"ID", "Name", "Phone", "Area", "Budget", "Grade"};
	...
	public void removefromDB()
	{
        ...
        try
		{
			...
			String query1="DELETE from assignedto WHERE  Sid_sa= ('"+teacher_id+"');";
			String query2="DELETE from login WHERE  UserId_ui= ('"+teacher_id+"');";
			String query3="DELETE from student WHERE  Sid_si= ('"+teacher_id+"');";
			String query4="DELETE from choice WHERE  Sid_sc= ('"+teacher_id+"');";
			String query5="DELETE from rating WHERE  Sid_ra= ('"+teacher_id+"');";
			//String query2="SELECT `TID_ta` FROM `assignedto` WHERE `TID_ta`= ('"+teacher_id+"');";
			System.out.println(query1);
			...
			Show_Student l  =new Show_Student();
			l.setVisible(true);
			this.setVisible(false);			
		}
        catch(Exception ex)
